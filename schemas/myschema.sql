...
--
-- Name: n_article_id_seq; Type: SEQUENCE; Schema: public; Owner: lctgrghalplphg
--
...
ALTER TABLE n_article_id_seq OWNER TO lctgrghalplphg;
...
--
-- Name: n_article; Type: TABLE; Schema: public; Owner: lctgrghalplphg; Tablespace: 
--
...
ALTER TABLE n_article OWNER TO lctgrghalplphg;

--
-- Name: comment_id_seq; Type: SEQUENCE; Schema: public; Owner: lctgrghalplphg
--
...
ALTER TABLE comment_id_seq OWNER TO lctgrghalplphg;

--
-- Name: comment; Type: TABLE; Schema: public; Owner: lctgrghalplphg; Tablespace: 
--
...
ALTER TABLE comment OWNER TO lctgrghalplphg;

--
-- Name: user_id_seq; Type: SEQUENCE; Schema: public; Owner: lctgrghalplphg
--
...
ALTER TABLE user_id_seq OWNER TO lctgrghalplphg;

--
-- Name: user; Type: TABLE; Schema: public; Owner: lctgrghalplphg; Tablespace: 
--
...
ALTER TABLE "user" OWNER TO lctgrghalplphg;
...
ALTER TABLE visitors OWNER TO lctgrghalplphg;

--
-- Data for Name: n_article; Type: TABLE DATA; Schema: public; Owner: lctgrghalplphg
--
...
--
-- Name: n_article_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lctgrghalplphg
--
...
--
-- Data for Name: comment; Type: TABLE DATA; Schema: public; Owner: lctgrghalplphg
--
...
--
-- Name: comment_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lctgrghalplphg
--
...
--
-- Name: user_id_seq; Type: SEQUENCE SET; Schema: public; Owner: lctgrghalplphg
--
...
--
-- Name: n_article_id; Type: CONSTRAINT; Schema: public; Owner: lctgrghalplphg; Tablespace: 
--
...
--
-- Name: n_article_title; Type: CONSTRAINT; Schema: public; Owner: lctgrghalplphg; Tablespace: 
--
...
--
-- Name: comment_id; Type: CONSTRAINT; Schema: public; Owner: lctgrghalplphg; Tablespace: 
--
...
--
-- Name: user_id; Type: CONSTRAINT; Schema: public; Owner: lctgrghalplphg; Tablespace: 
--
...
--
-- Name: user_username; Type: CONSTRAINT; Schema: public; Owner: lctgrghalplphg; Tablespace: 
--
...
--
-- Name: n_article_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: lctgrghalplphg
--
...
--
-- Name: comment_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: lctgrghalplphg
--
...
--
-- Name: public; Type: ACL; Schema: -; Owner: lctgrghalplphg
--

REVOKE ALL ON SCHEMA public FROM PUBLIC;
REVOKE ALL ON SCHEMA public FROM lctgrghalplphg;
GRANT ALL ON SCHEMA public TO lctgrghalplphg;
